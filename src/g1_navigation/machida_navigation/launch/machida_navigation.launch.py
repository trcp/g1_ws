...
def generate_launch_description():
    ...
    declarations = [
        ...
        DeclareLaunchArgument('goal_snap_max_dist', default_value='1.8',
        ...
        DeclareLaunchArgument('path_check_skip_radius', default_value='0.27',
        ...
        DeclareLaunchArgument('replan_cooldown', default_value='10.0'), # default 2.0, 5.0 is good
